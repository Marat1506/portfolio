...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send('service_pxb1uan', 'template_28ir5cv',
      {
        from_name: form.name,
        to_name: 'Marat',
        from_email: form.email,
        to_email: 'maratmirzabalaev@gmail.com',
  ...
  return (
    ...
    flex-col-reverse flex gap-10 overflow-hidden">
      <motion.div
        ...
        <h3 className={styles.sectionSubText}>Контакты</h3>
        ...
        <form
          ...
          <label className="flex flex-col">
            <span className="text-white font-medium">Текст</span>
            <input
              rows="7"
              name="message"
              value={form.message}
